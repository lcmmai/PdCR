from seg_model.model_utils import BceDiceLoss, CeDiceLoss, BCE_DiceLoss


class HAM10000_general_config:
    data_name = 'HAM10000'
    data_path = 'your HAM10000 data path'
    image_size = (256, 256)
    ...
    # loss_weight = [1, 1]
    # criterion = CeDiceLoss(1, loss_weight)

    num_workers = 4
    batch_size = 32
    epochs = 100

    coord_file = 'demo/HAM10000_block_coords_p32_b8.txt'    # your coord file(.txt)
...
class FIVES_general_config:
    ...
    coord_file = 'demo/FIVES_block_coords_p32_b32.txt'    # your coord file(.txt)
